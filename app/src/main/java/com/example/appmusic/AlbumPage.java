...
public class AlbumPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvSongInAlbum.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(AlbumPage.this, MainActivity.class);//sửa lại thành page play song khi có
                intent.putExtra("idSong", songAdapter.getItem(position).get_id());
    ...
    private void getSongsInAlbum(){
        ...
        Call<AlbumResponse> call = method.getById("6156f56ee3fd24179c29a354");
    ...
    public void playMainSong(View view) {
        Intent intent = new Intent(AlbumPage.this, MainActivity.class);// sửa lại thành page play nhạc
        intent.putExtra("idSong", album.getMainSong().get_id());
        startActivity(intent);
    }
}